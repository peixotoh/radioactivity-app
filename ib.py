...
try:
    ...
    with col1:
        ...
        # additional info
        st.markdown("This visualisation is based on the simulation of radioactive cloud released from the :red[_{central_name}_] on :blue[_{date_str}_]. For detailed information, maps and data, visit the Intitut Biosphèere web site: https://nrisk.institutbiosphere.ch/in-en.html")
          
        
    
    with col3:
        #st.header(f"Number of persons affected :red[_Europe_]")
